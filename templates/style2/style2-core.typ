// core styling functions and configurations for style2 templates
// this module contains all the shared styling logic
...
// adjustment configurations by vibe
#let get_adjustments(vibe, base-font-size) = {
...
// apply common text and paragraph styling
#let apply_text_styling(fonts, adjustments, doc) = {
  set text(
    font: fonts.serif,
...
// apply table styling
#let apply_table_styling(adjustments) = {
  set table(
    stroke: (x, y) => {
      if y == 0 { 
...
// apply link and emphasis styling
#let apply_text_effects() = {
...
#let render_header(title, subtitle, author, date, abstract, fonts) = {
