...
% let's use LuaTeX instead of XeTeX
...
% let's do a standard 1in margin
...
% % let's use the Libertine font
% \setmainfont{Linux Libertine O}

% % actually, let's use Domitian, which is like Palatino
% \setmainfont{domitian}

% https://tex.stackexchange.com/a/269614
...
% % let's use a garamond for the main font
% \setmainfont{ebgaramond}
% % and let's use inconsolata for the monospace font
% \setmonofont{inconsolata}
% % and let's use Fira Sans for the sans-serif font
% \setsansfont{Fira Sans}

% % new theme: Alegreya, Iosevka, Fira Sans
...
\ifdefstring{\vibe}{classic}{%
  ...
  \setmainfont{Alegreya}
  \setmonofont{Iosevka Slab}[Scale=0.8]
  \setsansfont{Fira Sans}
}{}
