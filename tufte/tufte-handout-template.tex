...
% for no-language code blocks
\DefineVerbatimEnvironment{verbatim}{Verbatim}{commandchars=\\\{\}}
...
\newcommand{\BuiltInTok}[1]{\textcolor[rgb]{0.25,0.44,0.63}{\textbf{{#1}}}}
